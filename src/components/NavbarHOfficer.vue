...
export default {
    ...
    slideexit: false,
    menu : [
        {menu:'1',text:'Dashboard', route:'/DashboardHofficer',icon:'home',},
        {menu:'2',text:'จัดการ Froms', route:'/petitionHofficer',icon:'file-document',},
        {menu:'3',text:'จัดการ Office', route:'/CRUDOFFICEHofficer',icon:'account-check',},
